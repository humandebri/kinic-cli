...
//! Where: Internet Identity login flow in the Kinic CLI.
//! What: Hosts a local callback server, opens the browser, and saves delegation.
//! Why: Avoids requiring a keychain-backed dfx identity for CLI-only login.
